...
@Deprecated("Replaced by com.android.build.api.dsl.ApplicationExtension.\nThis class is not used for the public extensions in AGP when android.newDsl=true, which is the default in AGP 9.0, and will be removed in AGP 10.0.", level = DeprecationLevel.WARNING)
